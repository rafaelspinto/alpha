...
For this connector to be *plugged* a class named *MySQLConnector* that implements a *ConnectorInterface* should exist inside the folder in the root called ```connectors```. [(go to available connectors)](https://github.com/pintorafael/alpha_connectors)
